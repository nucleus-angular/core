describe('Helper', function(){
  ...
  it('should resolve template path starting with / as itself', function() {
    expect(nagHelper.resolveTemplatePath('/test.html', {
  ...
  it('should resolve template path by adding rootTemplatePath to the beginning', function() {
    expect(nagHelper.resolveTemplatePath('test.html', {
      rootTemplatePath: '/whatever'
    })).to.equal('/whatever/test.html');
  });

  it('should resolve template path by to itself if it does not have .html in the template', function() {
    expect(nagHelper.resolveTemplatePath('inline-template-id', {
      rootTemplatePath: '/whatever'
    })).to.equal('inline-template-id');
  });
